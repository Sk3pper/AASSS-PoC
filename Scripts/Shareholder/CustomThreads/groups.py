...
class parametres:
    ...
    IP_BRD_HOST = "10.0.0.255"  # container
    ...
    COD500_desc = "Problem while Shareholder was saving the share"
    COD530 = "530"  # User already signedup [Shareholder]
    COD530_desc = "User already signed-up [Shareholder]"
    ...
    # OLD
    COD450 = "450"  # (s_i,t_i) is not consistent with commitments
