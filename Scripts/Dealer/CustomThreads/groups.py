...
# questi valori sono stati ottenuti dallo script PrimeNumberss
...
class parametres:
    ...
    FILE_NAME_SHARE = "share_information"
    FILE_NAME_COMM = "commitments"
    FILE_NAME_MC = "MC_information"
    FILE_NAME_NW_INFORMATION = "new_information"
    ...
    INTERFACE = 'ethwe0'  # containter
    INTERFACE2 = 'eth1'  # containter
    PORT_TO_LISTEN = 8000

    # IP_BRD_HOST = "10.10.10.255" # local MAC
    BROADCAST = "10.0.0.255"  # container

    PORT_SHAREHOLDERS = 7000
    # qua ci deve essere la lista degli shareholder, che mettero statici, cosi sempre lo stesso indirizzp
    # siccome non si possono mettere gli ipstatici,vanno bene solo i nomi

    IP_SHAREHOLDERS = ["Jarvis1", "Jarvis2", "Jarvis3", "Jarvis4", "Jarvis5"]#, "Jarvis6", "Jarvis7", "Jarvis8", "Jarvis9", "Jarvis10"]

    PORT_EXTERNAL_SERVER = 6000
    IP_EXTERNAL_SERVER = "ExternalServer"
